...
| ID | Criterion |
|---|---|
| AC-05-01 | Any authenticated user may create a room |
...
| AC-05-06 | Authenticated user can freely join public room unless banned from it |
| AC-05-07 | User can leave any room |
| AC-05-08 | Owner cannot leave own room |
| AC-05-09 | Only owner can delete room |
| AC-05-10 | Deleting a room deletes all messages + attachments permanently |
| AC-05-11 | User can invite another user to a private room |
...
- `GET /api/v1/rooms/my` → rooms user is member of
