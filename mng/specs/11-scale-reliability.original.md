...
## Goal
Meet non-functional targets. Load-test; verify consistency invariants; harden async cleanup.
...
- Consider partitioning `messages` by room_id hash at scale; not required for 300 users
