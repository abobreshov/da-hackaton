...
## Goal
Self-registration, login, password management, account deletion with cascade. Persistent login across browser restart.

## Scope
- Register (email + username + password)
- Uniqueness rules: email unique, username unique, username immutable
- No email verification
- Sign in / sign out (current browser session only)
- Password reset
- Password change (logged in)
- Passwords stored hashed (bcrypt ≥12 rounds; already in code)
...
| AC-01-03 | Username cannot be changed after registration |
